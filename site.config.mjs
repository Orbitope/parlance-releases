...
export default {
  ...
  docsSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "docs/concepts/prose-check/", label: "The prose check" },
        { href: "docs/concepts/conditional-narration/", label: "Conditional narration" },
  ...
  pages: [
    ...
    { src: "content/docs/concepts/prose-check.md", out: "docs/concepts/prose-check/index.html" },
    { src: "content/docs/concepts/conditional-narration.md", out: "docs/concepts/conditional-narration/index.html" },
